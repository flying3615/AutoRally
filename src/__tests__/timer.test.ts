...
vi.mock('../renderer/alarm/classic-alarm-995.wav', () => ({ default: '' }), { virtual: true });
vi.mock('../renderer/alarm/mixkit-security-facility-breach-alarm-994.wav', () => ({ default: '' }), { virtual: true });
